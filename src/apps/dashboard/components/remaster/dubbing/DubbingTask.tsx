...
import { getTasksByCategory } from '../../../features/tasks/utils/tasks';
    ...
    return (
        <Box className='readOnlyContent'>
            <Stack spacing={3} mt={2}>
                <Tasks
                    key={'Remaster'}
                    category={'Remaster Tasks'}
                    tasks={getTasksByCategory(tasks, 'RemasterDubbing')}
                />
            </Stack>
        </Box>
    );
...
DubbingTask.displayName = 'RemasterDubbingTask';
